...
const sidebarColors = {
  ...
  primaryMuted: '#8ecdf8',
  primaryHover: '#0d8ecf',
  primaryGlow: 'rgba(29,161,242,0.07)',
  primarySoft: 'rgba(29,161,242,0.10)',

  // ── SURFACE FX / AUTH PAGES / GLASS CARDS ─────────────────────
  authPageBg: '#000000',
  authCardBg: 'rgba(23,24,28,0.88)',
  authCardBorder: 'rgba(29,161,242,0.28)',
  ...
  focusRing: 'rgba(29,161,242,0.15)',

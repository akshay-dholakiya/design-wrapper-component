...
export const chartColors = {
  ...
  severity:    { critical: "#ef4444", high: "#f97316", medium: "#eab308", low: "#f97316", info: "#fb923c" },
  series:      ["#f97316","#fb923c","#eab308","#f59e0b","#fbbf24","#ef4444","#ec4899","#a78bfa","#14b8a6","#84cc16"],
  categorical: ["#f97316","#fb923c","#f59e0b","#fbbf24","#eab308","#facc15","#ef4444","#f87171","#ec4899","#f472b6"],
  gradients: {

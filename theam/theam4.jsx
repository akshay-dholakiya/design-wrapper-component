...
export const chartColors = {
  ...
  severity:    { critical: "#ef4444", high: "#f97316", medium: "#f59e0b", low: "#4a9e4a", info: "#6abf6a" },
  series:      ["#4a9e4a","#6abf6a","#336e33","#88cc88","#255225","#ef4444","#ec4899","#f59e0b","#a78bfa","#84cc16"],
  categorical: ["#4a9e4a","#6abf6a","#336e33","#88cc88","#255225","#a8dba8","#ef4444","#f87171","#ec4899","#f472b6"],
  gradients: {
